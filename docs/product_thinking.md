...
This document covers the design rationale behind IAM Risk Digest: why the problem was framed this way, why existing tooling was considered insufficient, which capabilities were deliberately excluded and why, and how the priority, scoring, and data quality systems were designed. For install and run steps, see [user guide](user_guide.md). The technical build specification lives in [README.md](README.md).
